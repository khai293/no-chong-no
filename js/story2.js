...
k2_notice: [
  ...
  {who:'sys', text:'"THẬN PHÁT LỘC — THU MUA TẬN TÂM, GIÁ TẬN NÓC, MỔ TẬN GIƯỜNG. Ưu đãi khách quen: bán quả thứ 2 tặng ngay bình giữ nhiệt."'},
  {who:'chau', expr:'cry', text:'ĐỒ NGỐC!!! Anh ta định BÁN NỐT QUẢ THẬN CÒN LẠI để lo viện phí cho MẸ MÌNH!!!'},
...
k2_confront: [
  ...
  {who:'khai', expr:'gloom', text:'Anh tính kỹ rồi. Thận này họ trả 250 triệu. Đủ mổ tim cho bác, còn dư mua thuốc. Còn anh... người ta sống được với một quả thận mà. Số dư về 0 thì... từ từ tính.'},
  ...
  {who:'bacsi', expr:'gloom', text:'Tôi TRÀ TRỘN, cô ơi. Gom bằng chứng cho công an suốt ba tháng nay. Y tá Hồng vừa nhắn tôi là có người quen sập bẫy... may mà kịp. Mà cậu kia, tôi nói thật: thận cậu suy dinh dưỡng do ăn mì tôm, có rao bán tụi nó cũng ép giá thôi.'},
  {who:'khai', expr:'dizzy', text:'Đến nội tạng của tôi cũng bị chê nghèo. Tận cùng của sự sỉ nhục.'},
...
k2_rescue: [
  {chars:[['khai','gloom']], bgc:'#e8d9f5', text:'Căn phòng sau tiệm gấu bông. Đèn mổ chế từ đèn pha xe máy. Lucien nằm trên bàn, tay nắm chặt tấm ảnh chụp phiếu phẫu thuật của bà Mai. "250 triệu... đủ cho bác mổ..."'},
